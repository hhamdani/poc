...
import com.houssem.poc.config.audit.AuditEventConverter;
import com.houssem.poc.domain.PersistentAuditEvent;
...
import static com.houssem.poc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
